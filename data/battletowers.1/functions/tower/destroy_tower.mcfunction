...
execute store result score #battletowers.do_tile_drops sourcecraft.temp run gamerule doTileDrops
#get current mobGreifing gamerule value
execute store result score #battletowers.mob_griefing sourcecraft.temp run gamerule mobGriefing

##set gamerule values
#temporarily set doTileDrops to false (if it is currently true)
execute unless score #battletowers.do_tile_drops sourcecraft.temp matches 0 run gamerule doTileDrops false
#temporarily set mobGreifing to true (if it is currently true)
execute unless score #battletowers.do_tile_drops sourcecraft.temp matches 1 run gamerule doTileDrops true
...
execute unless score #battletowers.do_tile_drops sourcecraft.temp matches 0 run gamerule doTileDrops true
#set mobGriefing back to true
execute unless score #battletowers.mob_griefing sourcecraft.temp matches 1 run gamerule mobGriefing false
...
schedule function battletowers.1:tower/queue_destroy_tower 35t append